...
# Now make a figure:
## Overall
fig1 <- mat_hist+map_hist+anpp_hist+plot_layout(axis_titles = 'collect')+
...
## Log transformed
fig2 <- mat_scatter+log_map_scatter+plot_layout(axis_titles = 'collect')+
  plot_annotation(tag_levels = 'a', tag_prefix = '(', tag_suffix = ')')&
  theme(plot.tag = element_text(face = 'bold'))
...
plot(map_vals, mat_coeff*mat_marginal^map_vals, type = 'l',
     xlab = 'MAP value',
