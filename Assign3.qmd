...
Again, a function to save typing:
...
# MAT
## Overall
mat_scatter <- plot_scatter(anpp_f, xvar = MAT, smooth_lty = 'solid')
...
# MAP
## Overall
map_scatter <- plot_scatter(anpp_f, xvar = MAP, smooth_lty = 'solid')
...
# Log MAP
## Overall
log_map_scatter <- plot_scatter(anpp_f, xvar = log(MAP), smooth_lty = 'solid')
